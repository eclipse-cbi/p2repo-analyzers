...
#    /shared/simrel/${release}/org.eclipse.cbi.p2repo.analyzers
...
source ${BUILD_HOME}/org.eclipse.cbi.p2repo.analyzers/aggr_properties.shsource

RELENG_TESTS_REPO=${RELENG_TESTS_REPO:-org.eclipse.cbi.p2repo.analyzers}
RELENG_TESTS_PATH=${RELENG_TESTS_PATH:-bundles/org.eclipse.cbi.p2repo.analyzers-bundle}
RELENG_TESTS_DIR=${RELENG_TESTS_DIR:-org.eclipse.cbi.p2repo.analyzers}
