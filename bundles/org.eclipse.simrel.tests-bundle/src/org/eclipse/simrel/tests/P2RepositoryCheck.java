...
public class P2RepositoryCheck {
    ...
    public boolean runChecks(RepoTestsConfiguration configuration) throws ProvisionException, OperationCanceledException {
        ...
        stopwatch.stop();
        return manager.getReports().stream().anyMatch(report -> report.getType() == ReportType.NOT_IN_TRAIN);
    }
}
